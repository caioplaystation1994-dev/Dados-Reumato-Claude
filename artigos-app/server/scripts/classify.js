...
//
// Uso: node server/scripts/classify.js --id 3 --json '{"title":"...","authors":"...","year":"2023","disease":"...","topics":"a, b, c","summary":"..."}'
...
if (!args.id || !args.json) {
  console.error('Uso: node server/scripts/classify.js --id <id> --json \'{"title":"...","authors":"...","year":"...","disease":"...","topics":"...","summary":"..."}\'');
  process.exit(1);
}
...
db.prepare(
  `UPDATE articles SET title = ?, authors = ?, year = ?, disease = ?, topics = ?, summary = ?, status = 'concluido', error = NULL WHERE id = ?`
).run(
